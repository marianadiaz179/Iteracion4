...
public class SalonConferencias implements VOSalonConferencias
{
	 ...
	 */
    public SalonConferencias(long id, long idServicio, int capacidadPersonas, String nombre) 
    {
    	this.id = id;
	...
	{
		return "SalonConferencias [id=" + id + ", idServicio=" + idServicio + ", capacidadPersonas=" + capacidadPersonas + ", nombre=" + nombre;
	}
